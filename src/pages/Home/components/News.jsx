  ...
  return (
    <div className="w-screen bg-slate-100 px-[5%] pb-6">
      ...
      >
        ...
        <b>JULY-24-2023: <Href text="pgsc_calc" href="https://pgsc-calc.readthedocs.io/en/latest/index.html"/> compatible model files are released! User guidance is available <Href text="here" href="https://www.omicspred.org/Scores"/>! </b>
        <br/>
